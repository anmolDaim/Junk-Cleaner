...
import com.mobcleaner.app.databinding.FragmentToolsThirdBinding
...
class ToolsThirdFragment : Fragment(), CoroutineScope {
    ...
    private fun showDialog() {
        ...
        val doneButton: AppCompatButton = dialogView.findViewById(R.id.doneButton) // New button for navigating to MainActivity
